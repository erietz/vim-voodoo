...
local theme_0    = placeholder_0
local theme_1    = placeholder_1
local theme_2    = placeholder_2
local theme_3    = placeholder_3
local theme_4    = placeholder_4
local theme_5    = placeholder_5
local theme_6    = placeholder_6
...
Group.new("NormalFloat",                colors.text_color, colors.grey_0,      styles.none)
...
Group.new('DiffText',                   colors.text_color, colors.grey_0,      styles.none)
-- COC
