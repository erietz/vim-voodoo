...
local background     = "#231F20"
local foreground     = "#DFBA84"
local voodoo_0       = "#363031"
local voodoo_1       = "#413A3B"
local voodoo_2       = "#4C4343"
local voodoo_3       = "#564D4F"
local voodoo_4       = "#615659"
local voodoo_5       = "#6C6063"
...
--
Group.new('Comment',             colors.voodoo_5,          colors.none,          styles.NONE)
--
...
--
Group.new('TabLineSel',          colors.voodoo_red,      colors.voodoo_0, styles.bold )
...
Group.new('StatusLine',          colors.voodoo_red,    colors.voodoo_0,      styles.bold)
...
Group.new("CursorLineNr",        colors.voodoo_red,      colors.none,          styles.NONE)
...
Group.new("NormalFloat",         colors.voodoo_brown,          colors.voodoo_0,      styles.none)
...
Group.new("SpellRare",           colors.voodoo_5,          colors.voodoo_0,      styles.none)
...
-- FZF
Group.new('fzf1',               colors.voodoo_red,      colors.background,      styles.none)
Group.new('fzf2',               colors.voodoo_brown,      colors.voodoo_0,      styles.none)
Group.new('fzf3',               colors.voodoo_brown,      colors.voodoo_0,      styles.none)
-- "+- Neovim Support -+
...
Group.new("IncSearch",           colors.voodoo_5,          colors.voodoo_fire,   styles.underline)
