...
let s:yellow  = [ "#5f3a91" , 215 ]
let s:orange  = [ "#9990bf" , 222 ]
let s:red     = [ "#cfcfe5" , 167 ]
let s:magenta = [ "#f7f7f6", 217 ]
let s:blue    = [ "#fed59f", 103 ]
let s:cyan    = [ "#ee9b39", 110 ]
let s:green   = [ "#bd6109", 107 ]
...
let g:lightline#colorscheme#PuOr_r#palette = lightline#colorscheme#flatten(s:p)
