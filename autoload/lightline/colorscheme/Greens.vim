...
let s:yellow  = [ "#e5f5e0" , 215 ]
let s:orange  = [ "#c7e9c0" , 222 ]
let s:red     = [ "#a0d99b" , 167 ]
let s:magenta = [ "#73c476", 217 ]
let s:blue    = [ "#40aa5d", 103 ]
let s:cyan    = [ "#228a44", 110 ]
let s:green   = [ "#006c2c", 107 ]
...
let g:lightline#colorscheme#Greens#palette = lightline#colorscheme#flatten(s:p)
