...
let s:yellow  = [ "#fff7bc" , 215 ]
let s:orange  = [ "#fee390" , 222 ]
let s:red     = [ "#fec34f" , 167 ]
let s:magenta = [ "#fe9829", 217 ]
let s:blue    = [ "#eb6f14", 103 ]
let s:cyan    = [ "#cb4b02", 110 ]
let s:green   = [ "#983404", 107 ]
...
let g:lightline#colorscheme#YlOrBr#palette = lightline#colorscheme#flatten(s:p)
