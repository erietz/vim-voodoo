...
let s:yellow  = [ "#0e726a" , 215 ]
let s:orange  = [ "#5bb3a8" , 222 ]
let s:red     = [ "#b6e3dd" , 167 ]
let s:magenta = [ "#f5f5f4", 217 ]
let s:blue    = [ "#f0deb0", 103 ]
let s:cyan    = [ "#cea053", 110 ]
let s:green   = [ "#975b12", 107 ]
...
let g:lightline#colorscheme#BrBG_r#palette = lightline#colorscheme#flatten(s:p)
