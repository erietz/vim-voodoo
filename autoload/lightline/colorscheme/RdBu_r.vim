...
let s:yellow  = [ "#2a71b2" , 215 ]
let s:orange  = [ "#6bacd1" , 222 ]
let s:red     = [ "#c2ddec" , 167 ]
let s:magenta = [ "#f7f6f6", 217 ]
let s:blue    = [ "#fbccb4", 103 ]
let s:cyan    = [ "#e48066", 110 ]
let s:green   = [ "#ba2832", 107 ]
...
let g:lightline#colorscheme#RdBu_r#palette = lightline#colorscheme#flatten(s:p)
