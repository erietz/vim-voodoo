...
let s:yellow  = [ "#f7fcb9" , 215 ]
let s:orange  = [ "#d9f0a3" , 222 ]
let s:red     = [ "#acdd8e" , 167 ]
let s:magenta = [ "#77c679", 217 ]
let s:blue    = [ "#40aa5c", 103 ]
let s:cyan    = [ "#228343", 110 ]
let s:green   = [ "#006737", 107 ]
...
let g:lightline#colorscheme#YlGn#palette = lightline#colorscheme#flatten(s:p)
