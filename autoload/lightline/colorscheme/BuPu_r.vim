...
let s:yellow  = [ "#810f7c" , 215 ]
let s:orange  = [ "#88419d" , 222 ]
let s:red     = [ "#8c6cb1" , 167 ]
let s:magenta = [ "#8c97c6", 217 ]
let s:blue    = [ "#9fbcda", 103 ]
let s:cyan    = [ "#c0d4e6", 110 ]
let s:green   = [ "#e1ecf4", 107 ]
...
let g:lightline#colorscheme#BuPu_r#palette = lightline#colorscheme#flatten(s:p)
