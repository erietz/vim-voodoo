...
let s:yellow  = [ "#0e0000" , 215 ]
let s:orange  = [ "#260000" , 222 ]
let s:red     = [ "#3f0000" , 167 ]
let s:magenta = [ "#5b0000", 217 ]
let s:blue    = [ "#770000", 103 ]
let s:cyan    = [ "#930000", 110 ]
let s:green   = [ "#af0000", 107 ]
...
let g:lightline#colorscheme#flag_r#palette = lightline#colorscheme#flatten(s:p)
