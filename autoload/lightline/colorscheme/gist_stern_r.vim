...
let s:yellow  = [ "#dfdf86" , 215 ]
let s:orange  = [ "#bfbf0d" , 222 ]
let s:red     = [ "#9f9f79" , 167 ]
let s:magenta = [ "#7f7ffe", 217 ]
let s:blue    = [ "#5f5fbe", 103 ]
let s:cyan    = [ "#0b3f7e", 110 ]
let s:green   = [ "#aa1f3e", 107 ]
...
let g:lightline#colorscheme#gist_stern_r#palette = lightline#colorscheme#flatten(s:p)
