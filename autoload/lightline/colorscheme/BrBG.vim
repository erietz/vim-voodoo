...
let s:yellow  = [ "#995d13" , 215 ]
let s:orange  = [ "#cfa256" , 222 ]
let s:red     = [ "#f1dfb3" , 167 ]
let s:magenta = [ "#f4f5f5", 217 ]
let s:blue    = [ "#b4e2db", 103 ]
let s:cyan    = [ "#58b0a7", 110 ]
let s:green   = [ "#0c7169", 107 ]
...
let g:lightline#colorscheme#BrBG#palette = lightline#colorscheme#flatten(s:p)
