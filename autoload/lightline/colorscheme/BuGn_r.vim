...
let s:red     = [ "#41ae77" , 167 ]
let s:magenta = [ "#67c2a5", 217 ]
let s:blue    = [ "#9ad8ca", 103 ]
let s:cyan    = [ "#cdece6", 110 ]
let s:green   = [ "#e5f5f9", 107 ]
...
let g:lightline#colorscheme#BuGn_r#palette = lightline#colorscheme#flatten(s:p)
