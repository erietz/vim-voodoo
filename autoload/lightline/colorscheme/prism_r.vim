...
let s:yellow  = [ "#ff6500" , 215 ]
let s:orange  = [ "#7200f8" , 222 ]
let s:red     = [ "#17cd1c" , 167 ]
let s:magenta = [ "#ffb000", 217 ]
let s:blue    = [ "#c100af", 103 ]
let s:cyan    = [ "#00878a", 110 ]
let s:green   = [ "#ffec00", 107 ]
...
let g:lightline#colorscheme#prism_r#palette = lightline#colorscheme#flatten(s:p)
