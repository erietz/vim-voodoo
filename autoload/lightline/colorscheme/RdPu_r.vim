...
let s:yellow  = [ "#7a0177" , 215 ]
let s:orange  = [ "#ae017e" , 222 ]
let s:red     = [ "#dd3597" , 167 ]
let s:magenta = [ "#f769a1", 217 ]
let s:blue    = [ "#faa0b5", 103 ]
let s:cyan    = [ "#fcc6c1", 110 ]
let s:green   = [ "#fde1de", 107 ]
...
let g:lightline#colorscheme#RdPu_r#palette = lightline#colorscheme#flatten(s:p)
