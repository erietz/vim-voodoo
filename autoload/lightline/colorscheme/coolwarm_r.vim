...
let s:yellow  = [ "#de614d" , 215 ]
let s:orange  = [ "#f49a7b" , 222 ]
let s:red     = [ "#f4c5ad" , 167 ]
let s:magenta = [ "#dcdddd", 217 ]
let s:blue    = [ "#b7cff9", 103 ]
let s:cyan    = [ "#8caffe", 110 ]
let s:green   = [ "#6180e9", 107 ]
...
let g:lightline#colorscheme#coolwarm_r#palette = lightline#colorscheme#flatten(s:p)
