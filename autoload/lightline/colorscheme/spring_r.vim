...
let s:yellow  = [ "#ffdf20" , 215 ]
let s:orange  = [ "#ffbf40" , 222 ]
let s:red     = [ "#ff9f60" , 167 ]
let s:magenta = [ "#ff7f80", 217 ]
let s:blue    = [ "#ff5fa0", 103 ]
let s:cyan    = [ "#ff3fc0", 110 ]
let s:green   = [ "#ff1fe0", 107 ]
...
let g:lightline#colorscheme#spring_r#palette = lightline#colorscheme#flatten(s:p)
