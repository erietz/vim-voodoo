...
let s:magenta = [ "#f6f7f7", 217 ]
let s:blue    = [ "#c0dceb", 103 ]
let s:cyan    = [ "#68abd0", 110 ]
let s:green   = [ "#2870b1", 107 ]
...
let g:lightline#colorscheme#RdBu#palette = lightline#colorscheme#flatten(s:p)
