...
let s:yellow  = [ "#fddaec" , 215 ]
let s:orange  = [ "#e5d8bd" , 222 ]
let s:red     = [ "#ffffcc" , 167 ]
let s:magenta = [ "#fed9a6", 217 ]
let s:blue    = [ "#decbe4", 103 ]
let s:cyan    = [ "#ccebc5", 110 ]
let s:green   = [ "#b3cde3", 107 ]
...
let g:lightline#colorscheme#Pastel1_r#palette = lightline#colorscheme#flatten(s:p)
