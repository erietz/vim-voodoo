...
let s:yellow  = [ "#ffffbf" , 215 ]
let s:orange  = [ "#fffe7f" , 222 ]
let s:red     = [ "#ffbe3f" , 167 ]
let s:magenta = [ "#fe7e00", 217 ]
let s:blue    = [ "#be3f00", 103 ]
let s:cyan    = [ "#7e0000", 110 ]
let s:green   = [ "#3e0000", 107 ]
...
let g:lightline#colorscheme#afmhot_r#palette = lightline#colorscheme#flatten(s:p)
