...
let s:yellow  = [ "#e6e57f" , 215 ]
let s:orange  = [ "#e6bf19" , 222 ]
let s:red     = [ "#e67f00" , 167 ]
let s:magenta = [ "#fd4028", 217 ]
let s:blue    = [ "#983381", 103 ]
let s:cyan    = [ "#4c26be", 110 ]
let s:green   = [ "#25257c", 107 ]
...
let g:lightline#colorscheme#CMRmap_r#palette = lightline#colorscheme#flatten(s:p)
