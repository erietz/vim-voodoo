...
let s:yellow  = [ "#bd0026" , 215 ]
let s:orange  = [ "#e31a1c" , 222 ]
let s:red     = [ "#fc4f2a" , 167 ]
let s:magenta = [ "#fd8e3c", 217 ]
let s:blue    = [ "#feb34d", 103 ]
let s:cyan    = [ "#fed977", 110 ]
let s:green   = [ "#ffeda1", 107 ]
...
let g:lightline#colorscheme#YlOrRd_r#palette = lightline#colorscheme#flatten(s:p)
