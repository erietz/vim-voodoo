...
let s:yellow  = [ "#bf5b17" , 215 ]
let s:orange  = [ "#f0027f" , 222 ]
let s:red     = [ "#386cb0" , 167 ]
let s:magenta = [ "#ffff99", 217 ]
let s:blue    = [ "#fdc086", 103 ]
let s:cyan    = [ "#beaed4", 110 ]
let s:green   = [ "#7fc97f", 107 ]
...
let g:lightline#colorscheme#Accent_r#palette = lightline#colorscheme#flatten(s:p)
