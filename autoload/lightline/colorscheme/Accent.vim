...
let s:yellow  = [ "#7fc97f" , 215 ]
let s:orange  = [ "#beaed4" , 222 ]
let s:red     = [ "#fdc086" , 167 ]
let s:magenta = [ "#ffff99", 217 ]
let s:blue    = [ "#386cb0", 103 ]
let s:cyan    = [ "#f0027f", 110 ]
let s:green   = [ "#bf5b17", 107 ]
...
let g:lightline#colorscheme#Accent#palette = lightline#colorscheme#flatten(s:p)
