...
let s:yellow  = [ "#fe9000" , 215 ]
let s:orange  = [ "#ffa000" , 222 ]
let s:red     = [ "#ffaf00" , 167 ]
let s:magenta = [ "#ffbd00", 217 ]
let s:blue    = [ "#ffd30d", 103 ]
let s:cyan    = [ "#ffe81b", 110 ]
let s:green   = [ "#f1f44b", 107 ]
...
let g:lightline#colorscheme#Wistia_r#palette = lightline#colorscheme#flatten(s:p)
