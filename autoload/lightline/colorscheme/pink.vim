...
let s:yellow  = [ "#744a4a" , 215 ]
let s:orange  = [ "#a16868" , 222 ]
let s:red     = [ "#c38280" , 167 ]
let s:magenta = [ "#d0ac94", 217 ]
let s:blue    = [ "#ddcda5", 103 ]
let s:cyan    = [ "#e9e9b6", 110 ]
let s:green   = [ "#f4f4de", 107 ]
...
let g:lightline#colorscheme#pink#palette = lightline#colorscheme#flatten(s:p)
