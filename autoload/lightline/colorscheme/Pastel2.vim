...
let s:yellow  = [ "#b3e2cd" , 215 ]
let s:orange  = [ "#fdcdac" , 222 ]
let s:red     = [ "#cbd5e8" , 167 ]
let s:magenta = [ "#f4cae4", 217 ]
let s:blue    = [ "#e6f5c9", 103 ]
let s:cyan    = [ "#fff2ae", 110 ]
let s:green   = [ "#f1e2cc", 107 ]
...
let g:lightline#colorscheme#Pastel2#palette = lightline#colorscheme#flatten(s:p)
