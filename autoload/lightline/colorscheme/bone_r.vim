...
let s:yellow  = [ "#d3e3e3" , 215 ]
let s:orange  = [ "#a7c7c7" , 222 ]
let s:red     = [ "#8ba1ab" , 167 ]
let s:magenta = [ "#6f7a8f", 217 ]
let s:blue    = [ "#535473", 103 ]
let s:cyan    = [ "#37374d", 110 ]
let s:green   = [ "#1b1b26", 107 ]
...
let g:lightline#colorscheme#bone_r#palette = lightline#colorscheme#flatten(s:p)
