...
let s:yellow  = [ "#ffeda0" , 215 ]
let s:orange  = [ "#fed976" , 222 ]
let s:red     = [ "#feb24c" , 167 ]
let s:magenta = [ "#fd8c3c", 217 ]
let s:blue    = [ "#fc4d2a", 103 ]
let s:cyan    = [ "#e2191c", 110 ]
let s:green   = [ "#bb0026", 107 ]
...
let g:lightline#colorscheme#YlOrRd#palette = lightline#colorscheme#flatten(s:p)
