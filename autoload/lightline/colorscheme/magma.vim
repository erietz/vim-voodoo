...
let s:yellow  = [ "#1d1147" , 215 ]
let s:orange  = [ "#51127c" , 222 ]
let s:red     = [ "#832681" , 167 ]
let s:magenta = [ "#b73779", 217 ]
let s:blue    = [ "#e75263", 103 ]
let s:cyan    = [ "#fc8961", 110 ]
let s:green   = [ "#fec488", 107 ]
...
let g:lightline#colorscheme#magma#palette = lightline#colorscheme#flatten(s:p)
