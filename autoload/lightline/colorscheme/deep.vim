...
let s:yellow  = [ "#4c72b0" , 215 ]
let s:orange  = [ "#dd8452" , 222 ]
let s:red     = [ "#55a868" , 167 ]
let s:magenta = [ "#c44e52", 217 ]
let s:blue    = [ "#8172b3", 103 ]
let s:cyan    = [ "#937860", 110 ]
let s:green   = [ "#da8bc3", 107 ]
...
let g:lightline#colorscheme#deep#palette = lightline#colorscheme#flatten(s:p)
