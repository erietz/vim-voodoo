...
let s:yellow  = [ "#fbb4ae" , 215 ]
let s:orange  = [ "#b3cde3" , 222 ]
let s:red     = [ "#ccebc5" , 167 ]
let s:magenta = [ "#decbe4", 217 ]
let s:blue    = [ "#fed9a6", 103 ]
let s:cyan    = [ "#ffffcc", 110 ]
let s:green   = [ "#e5d8bd", 107 ]
...
let g:lightline#colorscheme#Pastel1#palette = lightline#colorscheme#flatten(s:p)
