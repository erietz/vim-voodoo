...
let s:yellow  = [ "#4878d0" , 215 ]
let s:orange  = [ "#ee854a" , 222 ]
let s:red     = [ "#6acc64" , 167 ]
let s:magenta = [ "#d65f5f", 217 ]
let s:blue    = [ "#956cb4", 103 ]
let s:cyan    = [ "#8c613c", 110 ]
let s:green   = [ "#dc7ec0", 107 ]
