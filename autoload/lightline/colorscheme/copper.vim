...
let s:yellow  = [ "#281910" , 215 ]
let s:orange  = [ "#4f3220" , 222 ]
let s:red     = [ "#774b30" , 167 ]
let s:magenta = [ "#9e6440", 217 ]
let s:blue    = [ "#c67d50", 103 ]
let s:cyan    = [ "#ed9660", 110 ]
let s:green   = [ "#ffaf6f", 107 ]
...
let g:lightline#colorscheme#copper#palette = lightline#colorscheme#flatten(s:p)
