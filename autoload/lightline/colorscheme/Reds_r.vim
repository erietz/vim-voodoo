...
let s:yellow  = [ "#a50f15" , 215 ]
let s:orange  = [ "#cb181d" , 222 ]
let s:red     = [ "#ef3c2c" , 167 ]
let s:magenta = [ "#fb6b4b", 217 ]
let s:blue    = [ "#fc9373", 103 ]
let s:cyan    = [ "#fcbca2", 110 ]
let s:green   = [ "#fee1d3", 107 ]
...
let g:lightline#colorscheme#Reds_r#palette = lightline#colorscheme#flatten(s:p)
