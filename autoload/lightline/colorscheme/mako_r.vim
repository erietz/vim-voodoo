...
let s:yellow  = [ "#96ddb5" , 215 ]
let s:orange  = [ "#49c1ad" , 222 ]
let s:red     = [ "#359eaa" , 167 ]
let s:magenta = [ "#357aa2", 217 ]
let s:blue    = [ "#3c5598", 103 ]
let s:cyan    = [ "#3e3469", 110 ]
let s:green   = [ "#2a1b33", 107 ]
...
let g:lightline#colorscheme#mako_r#palette = lightline#colorscheme#flatten(s:p)
