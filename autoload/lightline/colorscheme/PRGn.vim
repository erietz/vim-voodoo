...
let s:yellow  = [ "#7f3c8d" , 215 ]
let s:orange  = [ "#ae8bbd" , 222 ]
let s:red     = [ "#dec9e2" , 167 ]
let s:magenta = [ "#f6f7f6", 217 ]
let s:blue    = [ "#cbeac5", 103 ]
let s:cyan    = [ "#7ec37f", 110 ]
let s:green   = [ "#298440", 107 ]
...
let g:lightline#colorscheme#PRGn#palette = lightline#colorscheme#flatten(s:p)
