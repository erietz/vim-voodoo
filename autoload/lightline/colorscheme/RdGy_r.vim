...
let s:yellow  = [ "#5c5c5c" , 215 ]
let s:orange  = [ "#a1a1a1" , 222 ]
let s:red     = [ "#d7d7d7" , 167 ]
let s:magenta = [ "#fffefe", 217 ]
...
let g:lightline#colorscheme#RdGy_r#palette = lightline#colorscheme#flatten(s:p)
