...
let s:yellow  = [ "#cae7f0" , 215 ]
let s:orange  = [ "#c7b2ed" , 222 ]
let s:red     = [ "#d383a6" , 167 ]
let s:magenta = [ "#9f7948", 217 ]
let s:blue    = [ "#417731", 103 ]
let s:cyan    = [ "#15524c", 110 ]
let s:green   = [ "#1b1c3a", 107 ]
...
let g:lightline#colorscheme#cubehelix_r#palette = lightline#colorscheme#flatten(s:p)
