...
let s:yellow  = [ "#ffff99" , 215 ]
let s:orange  = [ "#cab2d6" , 222 ]
let s:red     = [ "#ff7f00" , 167 ]
let s:magenta = [ "#e31a1c", 217 ]
let s:blue    = [ "#fb9a99", 103 ]
let s:cyan    = [ "#b2df8a", 110 ]
let s:green   = [ "#1f78b4", 107 ]
...
let g:lightline#colorscheme#Paired_r#palette = lightline#colorscheme#flatten(s:p)
