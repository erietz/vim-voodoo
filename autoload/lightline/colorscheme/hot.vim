...
let s:yellow  = [ "#5f0000" , 215 ]
let s:orange  = [ "#b30000" , 222 ]
let s:red     = [ "#ff0800" , 167 ]
let s:magenta = [ "#ff5c00", 217 ]
let s:blue    = [ "#ffb000", 103 ]
let s:cyan    = [ "#ffff07", 110 ]
let s:green   = [ "#ffff85", 107 ]
...
let g:lightline#colorscheme#hot#palette = lightline#colorscheme#flatten(s:p)
