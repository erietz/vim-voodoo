...
let s:yellow  = [ "#210c4a" , 215 ]
let s:orange  = [ "#57106e" , 222 ]
let s:red     = [ "#8a226a" , 167 ]
let s:magenta = [ "#bc3754", 217 ]
let s:blue    = [ "#e45a31", 103 ]
let s:cyan    = [ "#f98e09", 110 ]
let s:green   = [ "#f9cb35", 107 ]
...
let g:lightline#colorscheme#inferno#palette = lightline#colorscheme#flatten(s:p)
