...
let s:yellow  = [ "#980043" , 215 ]
let s:orange  = [ "#ce1256" , 222 ]
let s:red     = [ "#e72a8a" , 167 ]
let s:magenta = [ "#df66b0", 217 ]
let s:blue    = [ "#c995c7", 103 ]
let s:cyan    = [ "#d4bada", 110 ]
let s:green   = [ "#e7e2ef", 107 ]
...
let g:lightline#colorscheme#PuRd_r#palette = lightline#colorscheme#flatten(s:p)
