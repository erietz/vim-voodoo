...
let s:yellow  = [ "#db5f57" , 215 ]
let s:orange  = [ "#dbd057" , 222 ]
let s:red     = [ "#75db57" , 167 ]
let s:magenta = [ "#57dbaa", 217 ]
let s:blue    = [ "#579bdb", 103 ]
let s:cyan    = [ "#8557db", 110 ]
let s:green   = [ "#db57c0", 107 ]
...
let g:lightline#colorscheme#hls#palette = lightline#colorscheme#flatten(s:p)
