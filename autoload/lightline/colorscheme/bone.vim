...
let s:yellow  = [ "#1c1c27" , 215 ]
let s:orange  = [ "#38384e" , 222 ]
let s:red     = [ "#545574" , 167 ]
let s:magenta = [ "#707b90", 217 ]
let s:blue    = [ "#8ca2ac", 103 ]
let s:cyan    = [ "#a9c8c8", 110 ]
let s:green   = [ "#d5e4e4", 107 ]
...
let g:lightline#colorscheme#bone#palette = lightline#colorscheme#flatten(s:p)
