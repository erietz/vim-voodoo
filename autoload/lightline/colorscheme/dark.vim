...
let s:yellow  = [ "#001c7f" , 215 ]
let s:orange  = [ "#b1400d" , 222 ]
let s:red     = [ "#12711c" , 167 ]
let s:magenta = [ "#8c0800", 217 ]
let s:blue    = [ "#591e71", 103 ]
let s:cyan    = [ "#592f0d", 110 ]
let s:green   = [ "#a23582", 107 ]
...
let g:lightline#colorscheme#dark#palette = lightline#colorscheme#flatten(s:p)
