...
let s:yellow  = [ "#9fcfdf" , 215 ]
let s:orange  = [ "#3f9fbf" , 222 ]
let s:red     = [ "#006f9f" , 167 ]
let s:magenta = [ "#003f7f", 217 ]
let s:blue    = [ "#000f5f", 103 ]
let s:cyan    = [ "#00213f", 110 ]
let s:green   = [ "#00511f", 107 ]
...
let g:lightline#colorscheme#ocean_r#palette = lightline#colorscheme#flatten(s:p)
