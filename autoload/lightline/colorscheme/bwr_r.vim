...
let s:yellow  = [ "#ff4040" , 215 ]
let s:orange  = [ "#ff8080" , 222 ]
let s:red     = [ "#ffc0c0" , 167 ]
let s:magenta = [ "#fefeff", 217 ]
let s:blue    = [ "#bebeff", 103 ]
let s:cyan    = [ "#7e7eff", 110 ]
let s:green   = [ "#3e3eff", 107 ]
...
let g:lightline#colorscheme#bwr_r#palette = lightline#colorscheme#flatten(s:p)
