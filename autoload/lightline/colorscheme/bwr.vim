...
let s:yellow  = [ "#4040ff" , 215 ]
let s:orange  = [ "#8080ff" , 222 ]
let s:red     = [ "#c0c0ff" , 167 ]
let s:magenta = [ "#fffefe", 217 ]
let s:blue    = [ "#ffbebe", 103 ]
let s:cyan    = [ "#ff7e7e", 110 ]
let s:green   = [ "#ff3e3e", 107 ]
...
let g:lightline#colorscheme#bwr#palette = lightline#colorscheme#flatten(s:p)
