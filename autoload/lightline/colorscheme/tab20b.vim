...
let s:yellow  = [ "#393b79" , 215 ]
let s:orange  = [ "#5254a3" , 222 ]
let s:red     = [ "#6b6ecf" , 167 ]
let s:magenta = [ "#9c9ede", 217 ]
let s:blue    = [ "#637939", 103 ]
let s:cyan    = [ "#8ca252", 110 ]
let s:green   = [ "#b5cf6b", 107 ]
...
let g:lightline#colorscheme#tab20b#palette = lightline#colorscheme#flatten(s:p)
