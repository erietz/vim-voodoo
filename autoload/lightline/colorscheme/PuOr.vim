...
let s:yellow  = [ "#be630a" , 215 ]
let s:orange  = [ "#ef9e3c" , 222 ]
let s:red     = [ "#fed7a2" , 167 ]
let s:magenta = [ "#f6f6f7", 217 ]
let s:blue    = [ "#cecde4", 103 ]
let s:cyan    = [ "#988dbe", 110 ]
let s:green   = [ "#5d3790", 107 ]
...
let g:lightline#colorscheme#PuOr#palette = lightline#colorscheme#flatten(s:p)
