...
let s:yellow  = [ "#26487e" , 215 ]
let s:orange  = [ "#1e5e87" , 222 ]
let s:red     = [ "#21728b" , 167 ]
let s:magenta = [ "#34858d", 217 ]
let s:blue    = [ "#49988f", 103 ]
let s:cyan    = [ "#62ab90", 110 ]
let s:green   = [ "#82bc91", 107 ]
...
let g:lightline#colorscheme#crest_r#palette = lightline#colorscheme#flatten(s:p)
