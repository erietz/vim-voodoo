...
let s:yellow  = [ "#5183bb" , 215 ]
let s:orange  = [ "#90c3dd" , 222 ]
let s:red     = [ "#d4edf4" , 167 ]
let s:magenta = [ "#fffebe", 217 ]
let s:blue    = [ "#fed283", 103 ]
let s:cyan    = [ "#f88c51", 110 ]
let s:green   = [ "#dd3d2d", 107 ]
...
let g:lightline#colorscheme#RdYlBu_r#palette = lightline#colorscheme#flatten(s:p)
