...
let s:yellow  = [ "#0173b2" , 215 ]
let s:orange  = [ "#de8f05" , 222 ]
let s:red     = [ "#029e73" , 167 ]
let s:magenta = [ "#d55e00", 217 ]
let s:blue    = [ "#cc78bc", 103 ]
let s:cyan    = [ "#ca9161", 110 ]
let s:green   = [ "#fbafe4", 107 ]
...
let g:lightline#colorscheme#colorblind#palette = lightline#colorscheme#flatten(s:p)
