...
let s:yellow  = [ "#993404" , 215 ]
let s:orange  = [ "#cc4c02" , 222 ]
let s:red     = [ "#ec7014" , 167 ]
let s:magenta = [ "#fe9a2a", 217 ]
let s:blue    = [ "#fec550", 103 ]
let s:cyan    = [ "#fee392", 110 ]
let s:green   = [ "#fff7bd", 107 ]
...
let g:lightline#colorscheme#YlOrBr_r#palette = lightline#colorscheme#flatten(s:p)
