...
let s:yellow  = [ "#ed7b3e" , 215 ]
let s:orange  = [ "#b63441" , 222 ]
let s:red     = [ "#5a2834" , 167 ]
let s:magenta = [ "#1f1e1e", 217 ]
let s:blue    = [ "#38365f", 103 ]
let s:cyan    = [ "#3f69c9", 110 ]
let s:green   = [ "#63adcd", 107 ]
...
let g:lightline#colorscheme#icefire_r#palette = lightline#colorscheme#flatten(s:p)
