...
let s:yellow  = [ "#b30000" , 215 ]
let s:orange  = [ "#d7301f" , 222 ]
let s:red     = [ "#ef6548" , 167 ]
let s:magenta = [ "#fc8e5a", 217 ]
let s:blue    = [ "#fdbb85", 103 ]
let s:cyan    = [ "#fdd49f", 110 ]
let s:green   = [ "#fee8c9", 107 ]
...
let g:lightline#colorscheme#OrRd_r#palette = lightline#colorscheme#flatten(s:p)
