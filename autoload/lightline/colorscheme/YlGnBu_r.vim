...
let s:yellow  = [ "#253494" , 215 ]
let s:orange  = [ "#225ea8" , 222 ]
let s:red     = [ "#1d91c0" , 167 ]
let s:magenta = [ "#42b6c4", 217 ]
let s:blue    = [ "#80cebb", 103 ]
let s:cyan    = [ "#c8e9b4", 110 ]
let s:green   = [ "#edf8b2", 107 ]
...
let g:lightline#colorscheme#YlGnBu_r#palette = lightline#colorscheme#flatten(s:p)
