...
let s:yellow  = [ "#a52040" , 215 ]
let s:orange  = [ "#404080" , 222 ]
let s:red     = [ "#6060c0" , 167 ]
let s:magenta = [ "#8080fd", 217 ]
let s:blue    = [ "#a0a075", 103 ]
let s:cyan    = [ "#c0c011", 110 ]
let s:green   = [ "#e0e08a", 107 ]
...
let g:lightline#colorscheme#gist_stern#palette = lightline#colorscheme#flatten(s:p)
