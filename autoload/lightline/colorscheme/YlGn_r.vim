...
let s:yellow  = [ "#006837" , 215 ]
let s:orange  = [ "#238443" , 222 ]
let s:red     = [ "#42ab5d" , 167 ]
let s:magenta = [ "#79c679", 217 ]
let s:blue    = [ "#aedd8e", 103 ]
let s:cyan    = [ "#daf0a4", 110 ]
let s:green   = [ "#f7fcba", 107 ]
...
let g:lightline#colorscheme#YlGn_r#palette = lightline#colorscheme#flatten(s:p)
