...
let s:yellow  = [ "#0888ee" , 215 ]
let s:orange  = [ "#01cc66" , 222 ]
let s:red     = [ "#81e680" , 167 ]
let s:magenta = [ "#fefe98", 217 ]
let s:blue    = [ "#beac76", 103 ]
let s:cyan    = [ "#815e56", 110 ]
let s:green   = [ "#c1b0ac", 107 ]
...
let g:lightline#colorscheme#terrain#palette = lightline#colorscheme#flatten(s:p)
