...
let s:yellow  = [ "#f5ff00" , 215 ]
let s:orange  = [ "#0057c4" , 222 ]
let s:red     = [ "#f00071" , 167 ]
let s:magenta = [ "#ffd700", 217 ]
let s:blue    = [ "#00a462", 103 ]
let s:cyan    = [ "#a300cf", 110 ]
let s:green   = [ "#ff9400", 107 ]
...
let g:lightline#colorscheme#prism#palette = lightline#colorscheme#flatten(s:p)
