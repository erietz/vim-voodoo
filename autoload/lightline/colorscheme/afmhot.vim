...
let s:yellow  = [ "#400000" , 215 ]
let s:orange  = [ "#800000" , 222 ]
let s:red     = [ "#c04000" , 167 ]
let s:magenta = [ "#ff8001", 217 ]
let s:blue    = [ "#ffc041", 103 ]
let s:cyan    = [ "#ffff81", 110 ]
let s:green   = [ "#ffffc1", 107 ]
...
let g:lightline#colorscheme#afmhot#palette = lightline#colorscheme#flatten(s:p)
