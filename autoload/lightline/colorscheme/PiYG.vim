...
let s:yellow  = [ "#cb3289" , 215 ]
let s:orange  = [ "#e897c4" , 222 ]
let s:red     = [ "#fad6ea" , 167 ]
let s:magenta = [ "#f7f7f6", 217 ]
let s:blue    = [ "#d9f0bc", 103 ]
let s:cyan    = [ "#9acd61", 110 ]
let s:green   = [ "#589b28", 107 ]
...
let g:lightline#colorscheme#PiYG#palette = lightline#colorscheme#flatten(s:p)
