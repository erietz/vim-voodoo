...
let s:yellow  = [ "#6282ea" , 215 ]
let s:orange  = [ "#8db0fe" , 222 ]
let s:red     = [ "#b9d0f9" , 167 ]
let s:magenta = [ "#dddcdc", 217 ]
let s:blue    = [ "#f5c4ac", 103 ]
let s:cyan    = [ "#f4987a", 110 ]
let s:green   = [ "#dd5f4b", 107 ]
...
let g:lightline#colorscheme#coolwarm#palette = lightline#colorscheme#flatten(s:p)
