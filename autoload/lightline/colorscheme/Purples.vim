...
let s:yellow  = [ "#efedf5" , 215 ]
let s:orange  = [ "#dadaeb" , 222 ]
let s:red     = [ "#bcbddc" , 167 ]
let s:magenta = [ "#9e9ac8", 217 ]
let s:blue    = [ "#807cba", 103 ]
let s:cyan    = [ "#6950a3", 110 ]
let s:green   = [ "#53268f", 107 ]
...
let g:lightline#colorscheme#Purples#palette = lightline#colorscheme#flatten(s:p)
