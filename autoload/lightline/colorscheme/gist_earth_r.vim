...
let s:yellow  = [ "#d9b59d" , 215 ]
let s:orange  = [ "#bcac62" , 222 ]
let s:red     = [ "#98af58" , 167 ]
let s:magenta = [ "#5ba04b", 217 ]
let s:blue    = [ "#3b8d63", 103 ]
let s:cyan    = [ "#2a727e", 110 ]
let s:green   = [ "#153778", 107 ]
...
let g:lightline#colorscheme#gist_earth_r#palette = lightline#colorscheme#flatten(s:p)
