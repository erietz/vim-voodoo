...
let s:yellow  = [ "#edf8b1" , 215 ]
let s:orange  = [ "#c6e9b4" , 222 ]
let s:red     = [ "#7ecdbb" , 167 ]
let s:magenta = [ "#40b5c4", 217 ]
let s:blue    = [ "#1d90c0", 103 ]
let s:cyan    = [ "#225da8", 110 ]
let s:green   = [ "#243392", 107 ]
...
let g:lightline#colorscheme#YlGnBu#palette = lightline#colorscheme#flatten(s:p)
