...
let s:yellow  = [ "#f781bf" , 215 ]
let s:orange  = [ "#a65628" , 222 ]
let s:red     = [ "#ffff33" , 167 ]
let s:magenta = [ "#ff7f00", 217 ]
let s:blue    = [ "#984ea3", 103 ]
let s:cyan    = [ "#4daf4a", 110 ]
let s:green   = [ "#377eb8", 107 ]
...
let g:lightline#colorscheme#Set1_r#palette = lightline#colorscheme#flatten(s:p)
