...
let s:yellow  = [ "#252525" , 215 ]
let s:orange  = [ "#525252" , 222 ]
let s:red     = [ "#737373" , 167 ]
let s:magenta = [ "#979797", 217 ]
let s:blue    = [ "#bebebe", 103 ]
let s:cyan    = [ "#dadada", 110 ]
let s:green   = [ "#f0f0f0", 107 ]
...
let g:lightline#colorscheme#Greys_r#palette = lightline#colorscheme#flatten(s:p)
