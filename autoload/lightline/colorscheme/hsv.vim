...
let s:yellow  = [ "#ffbd00" , 215 ]
let s:orange  = [ "#84ff00" , 222 ]
let s:red     = [ "#00ff39" , 167 ]
let s:magenta = [ "#00fff6", 217 ]
let s:blue    = [ "#004bff", 103 ]
let s:cyan    = [ "#7200ff", 110 ]
let s:green   = [ "#ff00cf", 107 ]
...
let g:lightline#colorscheme#hsv#palette = lightline#colorscheme#flatten(s:p)
