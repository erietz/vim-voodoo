...
let s:yellow  = [ "#bcbd22" , 215 ]
let s:orange  = [ "#7f7f7f" , 222 ]
let s:red     = [ "#e377c2" , 167 ]
let s:magenta = [ "#9467bd", 217 ]
let s:blue    = [ "#d62728", 103 ]
let s:cyan    = [ "#2ca02c", 110 ]
let s:green   = [ "#ff7f0e", 107 ]
...
let g:lightline#colorscheme#tab10_r#palette = lightline#colorscheme#flatten(s:p)
