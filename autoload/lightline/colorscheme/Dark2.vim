...
let s:yellow  = [ "#1b9e77" , 215 ]
let s:orange  = [ "#d95f02" , 222 ]
let s:red     = [ "#7570b3" , 167 ]
let s:magenta = [ "#e7298a", 217 ]
let s:blue    = [ "#66a61e", 103 ]
let s:cyan    = [ "#e6ab02", 110 ]
let s:green   = [ "#a6761d", 107 ]
...
let g:lightline#colorscheme#Dark2#palette = lightline#colorscheme#flatten(s:p)
