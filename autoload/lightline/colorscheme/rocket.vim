...
let s:yellow  = [ "#30173a" , 215 ]
let s:orange  = [ "#611f53" , 222 ]
let s:red     = [ "#971c5b" , 167 ]
let s:magenta = [ "#cb1b4f", 217 ]
let s:blue    = [ "#ec4c3e", 103 ]
let s:cyan    = [ "#f58860", 110 ]
let s:green   = [ "#f6bc99", 107 ]
...
let g:lightline#colorscheme#rocket#palette = lightline#colorscheme#flatten(s:p)
