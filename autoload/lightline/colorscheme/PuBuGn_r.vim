...
let s:yellow  = [ "#016c59" , 215 ]
let s:orange  = [ "#02818a" , 222 ]
let s:red     = [ "#3790c0" , 167 ]
let s:magenta = [ "#68a9cf", 217 ]
let s:blue    = [ "#a7bddb", 103 ]
let s:cyan    = [ "#d1d1e6", 110 ]
let s:green   = [ "#ede3f0", 107 ]
...
let g:lightline#colorscheme#PuBuGn_r#palette = lightline#colorscheme#flatten(s:p)
