...
let s:yellow  = [ "#f6bb97" , 215 ]
let s:orange  = [ "#f4865e" , 222 ]
let s:red     = [ "#ec4a3e" , 167 ]
let s:magenta = [ "#ca1a50", 217 ]
let s:blue    = [ "#951c5b", 103 ]
let s:cyan    = [ "#601f52", 110 ]
let s:green   = [ "#2e1739", 107 ]
...
let g:lightline#colorscheme#rocket_r#palette = lightline#colorscheme#flatten(s:p)
