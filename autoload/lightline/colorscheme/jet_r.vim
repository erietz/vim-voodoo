...
let s:yellow  = [ "#ff2200" , 215 ]
let s:orange  = [ "#ff9800" , 222 ]
let s:red     = [ "#e1ff16" , 167 ]
let s:magenta = [ "#7aff7d", 217 ]
let s:blue    = [ "#13fce4", 103 ]
let s:cyan    = [ "#007dff", 110 ]
let s:green   = [ "#0000ff", 107 ]
...
let g:lightline#colorscheme#jet_r#palette = lightline#colorscheme#flatten(s:p)
