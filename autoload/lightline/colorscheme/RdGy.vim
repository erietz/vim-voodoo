...
let s:yellow  = [ "#bb2a34" , 215 ]
let s:orange  = [ "#e58368" , 222 ]
let s:red     = [ "#fbceb7" , 167 ]
let s:magenta = [ "#fefefe", 217 ]
let s:blue    = [ "#d6d6d6", 103 ]
let s:cyan    = [ "#9f9f9f", 110 ]
let s:green   = [ "#5a5a5a", 107 ]
...
let g:lightline#colorscheme#RdGy#palette = lightline#colorscheme#flatten(s:p)
