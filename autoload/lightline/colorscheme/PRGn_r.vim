...
let s:yellow  = [ "#2b8642" , 215 ]
let s:orange  = [ "#81c581" , 222 ]
let s:red     = [ "#cdebc7" , 167 ]
let s:magenta = [ "#f7f6f7", 217 ]
let s:blue    = [ "#ddc7e1", 103 ]
let s:cyan    = [ "#ac89bc", 110 ]
let s:green   = [ "#7e398c", 107 ]
...
let g:lightline#colorscheme#PRGn_r#palette = lightline#colorscheme#flatten(s:p)
