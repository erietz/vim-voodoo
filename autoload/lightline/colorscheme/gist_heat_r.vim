...
let s:yellow  = [ "#ffbf7f" , 215 ]
let s:orange  = [ "#ff7f00" , 222 ]
let s:red     = [ "#ee3f00" , 167 ]
let s:magenta = [ "#be0000", 217 ]
let s:blue    = [ "#8e0000", 103 ]
let s:cyan    = [ "#5e0000", 110 ]
let s:green   = [ "#2f0000", 107 ]
...
let g:lightline#colorscheme#gist_heat_r#palette = lightline#colorscheme#flatten(s:p)
