...
let s:yellow  = [ "#fee6ce" , 215 ]
let s:orange  = [ "#fdd0a2" , 222 ]
let s:red     = [ "#fdae6a" , 167 ]
let s:magenta = [ "#fd8c3b", 217 ]
let s:blue    = [ "#f16813", 103 ]
let s:cyan    = [ "#d84801", 110 ]
let s:green   = [ "#a53603", 107 ]
...
let g:lightline#colorscheme#Oranges#palette = lightline#colorscheme#flatten(s:p)
