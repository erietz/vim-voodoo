...
let s:yellow  = [ "#54278f" , 215 ]
let s:orange  = [ "#6a51a3" , 222 ]
let s:red     = [ "#807dba" , 167 ]
let s:magenta = [ "#9e9bc8", 217 ]
let s:blue    = [ "#bdbedc", 103 ]
let s:cyan    = [ "#dadaeb", 110 ]
let s:green   = [ "#efedf5", 107 ]
...
let g:lightline#colorscheme#Purples_r#palette = lightline#colorscheme#flatten(s:p)
