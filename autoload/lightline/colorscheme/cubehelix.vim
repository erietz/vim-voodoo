...
let s:yellow  = [ "#1b1e3b" , 215 ]
let s:orange  = [ "#16534c" , 222 ]
let s:red     = [ "#447731" , 167 ]
let s:magenta = [ "#a1794a", 217 ]
let s:blue    = [ "#d484a9", 103 ]
let s:cyan    = [ "#c6b4ee", 110 ]
let s:green   = [ "#cbe8f0", 107 ]
...
let g:lightline#colorscheme#cubehelix#palette = lightline#colorscheme#flatten(s:p)
