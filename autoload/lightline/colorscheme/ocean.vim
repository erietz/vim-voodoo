...
let s:yellow  = [ "#005020" , 215 ]
let s:orange  = [ "#002040" , 222 ]
let s:red     = [ "#001060" , 167 ]
let s:magenta = [ "#004080", 217 ]
let s:blue    = [ "#0070a0", 103 ]
let s:cyan    = [ "#42a0c0", 110 ]
let s:green   = [ "#a2d0e0", 107 ]
