...
let g:airline#themes#rocket#palette.normal_modified = s:modified
...
let g:airline#themes#rocket#palette.insert_modified = s:modified
...
let g:airline#themes#rocket#palette.visual_modified = s:modified
...
let g:airline#themes#rocket#palette.replace_modified = s:modified
...
let g:airline#themes#rocket#palette.inactive = airline#themes#generate_color_map(s:IN1, s:IN2, s:IN3)
let g:airline#themes#rocket#palette.inactive_modified = s:modified
...
let g:airline#themes#rocket#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(s:CP1, s:CP2, s:CP3)
