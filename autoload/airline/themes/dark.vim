...
let g:airline#themes#dark#palette.insert_modified = s:modified
...
let g:airline#themes#dark#palette.visual_modified = s:modified
...
let g:airline#themes#dark#palette.replace_modified = s:modified
...
let g:airline#themes#dark#palette.inactive = airline#themes#generate_color_map(s:IN1, s:IN2, s:IN3)
let g:airline#themes#dark#palette.inactive_modified = s:modified
...
let g:airline#themes#dark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(s:CP1, s:CP2, s:CP3)
